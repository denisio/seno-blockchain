...
from seno.ssl.create_ssl import get_mozzila_ca_crt
...
service_plotter = "seno plots create"
...
class WebSocketServer:
    ...
    async def exit(self) -> Dict[str, Any]:
        ...
        log.info("seno daemon exiting in 5 seconds")
...
def launch_service(root_path: Path, service_command) -> Tuple[subprocess.Popen, Path]:
    ...
    log.debug(f"Launching service with SENO_ROOT: {os.environ['SENO_ROOT']}")
