...
from seno.wallet.sign_coin_solutions import sign_coin_solutions
...
class Wallet:
    ...
    async def create_spend_bundle_relative_seno(self, seno_amount: int, exclude: List[Coin]) -> SpendBundle:
        ...
        if seno_amount < 0:
            utxos = await self.select_coins(abs(seno_amount), exclude)
        else:
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": seno_amount}]
