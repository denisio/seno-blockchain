...
from seno.protocols.wallet_protocol import RespondAdditions, RejectAdditionsRequest
...
from seno.util.ints import uint64, uint32, uint8

from seno.wallet.did_wallet.did_info import DIDInfo
from seno.wallet.cc_wallet.ccparent import CCParent
