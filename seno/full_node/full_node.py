...
from seno.consensus.blockchain import Blockchain, ReceiveBlockResult
...
from seno.full_node.full_node_store import FullNodeStore
...
class FullNode:
    ...
    async def peak_post_processing(
        self, block: FullBlock, record: BlockRecord, fork_height: uint32, peer: Optional[ws.WSSenoConnection]
    ):
        """
