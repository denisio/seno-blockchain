...
import { Card, FormatLargeNumber, Link, Loading, TooltipIcon, Flex } from '@seno/core';
import {
  unix_to_short_date,
  hex_to_array,
  arr_to_hex,
...
export default function Block() {
  ...
  const poolReward = mojo_to_seno(calculatePoolReward(blockRecord.height));
  const baseFarmerReward = mojo_to_seno(calculateBaseFarmerReward(blockRecord.height));

  const senoFees = blockRecord.fees
    ? mojo_to_seno(BigInt(blockRecord.fees))
    : '';
