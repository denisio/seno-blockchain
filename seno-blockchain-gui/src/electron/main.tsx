...
import senoConfig from '../util/config';
...
if (!handleSquirrelEvent()) {
  ...
  if (ensureSingleInstance() && ensureCorrectEnvironment()) {
    ...
    senoConfig.loadConfig(senoEnvironment.getSenoVersion());
    ...
    const createWindow = () => {
      ...
      if (!senoConfig.manageDaemonLifetime()) {
      ...
      mainWindow.on('close', (e) => {
        ...
        if (decidedToClose || !senoConfig.manageDaemonLifetime()) {
          return;
        }
        e.preventDefault();
        if (!isClosing) {
      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/denisio/seno-blockchain/issues',
              );
            },
          },
          {
